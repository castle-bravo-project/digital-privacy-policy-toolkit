...
export const ScaleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M12 2v2"></path>
        <path d="M4.24 7.76l1.42-1.42"></path>
        <path d="M18.34 6.34l1.42 1.42"></path>
        <path d="M20 12h2"></path>
        <path d="M2 12H4"></path>
        <path d="M4.24 16.24l1.42 1.42"></path>
        <path d="M18.34 17.66l1.42-1.42"></path>
        <path d="M12 20v2"></path>
        <path d="M12 6a6 6 0 0 1 6 6H6a6 6 0 0 1 6-6z"></path>
    </svg>
);
...
export const LightbulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M9 18h6" />
        <path d="M10 22h4" />
        <path d="M12 2a7 7 0 0 0-7 7c0 3.03 1.06 4.79 3 7h8c1.94-2.21 3-3.97 3-7a7 7 0 0 0-7-7Z" />
    </svg>
);
...
export const WandIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M20 12h2" />
        <path d="M14 12h-2" />
        <path d="M20.5 10.5L19 12" />
        <path d="M3 3l12 12" />
        <path d="m19 21-1.2-1.2" />
        <path d="M21 15l-1-1" />
        <path d="M9.5 14.5L8 16" />
        <path d="M6.5 8.5L5 10" />
    </svg>
);
...
export const IdCardIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M15 12h2" />
        <path d="M15 16h5" />
        <path d="M8 14c0-1.33 2-2 3-2s3 .67 3 2" />
    </svg>
);
...
export const ShieldOffIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
